...
<button onClick={removeElement} id={"_btn"} style={{ display: 'inline-flex', justifyContent: 'center', alignItems: 'center', padding: 0, border: 'none', background: 'none', width: '50px', height: '50px', borderRadius: '50%' }}>
